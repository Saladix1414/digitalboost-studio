...
function analyze(q: string, section: string) {
  ...
  if (s.indexOf("hola") !== -1 || s.indexOf("quien") !== -1 || s.indexOf("sos") !== -1) {
    return builder
      ...
      : { title: "PULSE IA", body: "Estoy en Commerce OS · " + stamp + ". Opero ventas, stock, pedidos y campanas de esta tienda.", action: "dashboard", actionLabel: "Seguir en Overview", confirm: false };
  }
  if (builder) {
