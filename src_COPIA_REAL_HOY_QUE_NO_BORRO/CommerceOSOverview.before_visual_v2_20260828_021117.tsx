...
export default function CommerceOSOverview({ onNavigate }: CommerceOSOverviewProps) {
  ...
  if (!booted) {
    return (
      <div className="relative min-h-[720px] overflow-hidden rounded-[28px] border border-white/10 bg-[#030817] text-white shadow-2xl shadow-cyan-500/25 db-commerce-jewel" data-commerce-os="true" data-commerce-os-core="true" data-commerce-os-vibrant="true">
