...
function analyze(q: string) {
  ...
  if (s.indexOf("hola") !== -1 || s.indexOf("quien") !== -1 || s.indexOf("sos") !== -1)
    return { title: "PULSE IA", body: "Soy PULSE, la inteligencia de DigitalBoost. Opero el comercio: ventas, stock, conversion y la tienda. No soy un chat generico.", action: "dashboard", actionLabel: "Seguir en Overview", confirm: false };
  ...
  return { title: "PULSE IA", body: "Decime el frente: ventas, stock, conversion, clientes o una campana. Yo opero DigitalBoost.", action: "dashboard", actionLabel: "Ir a Overview", confirm: false };
}
