...
import "./commerce-os-jewel-v2.css";
...
const navGroups: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    title: "Experience",
    items: [
      { id: "website-builder", label: "Store Builder", icon: Globe2, badge: "NEW" },
...
export default function CommerceOSOverview({ onNavigate }: CommerceOSOverviewProps) {
  ...
  if (!booted) {
    return (
      <div className="relative min-h-[720px] overflow-hidden rounded-[28px] border border-white/10 bg-[#030817] text-white shadow-2xl shadow-cyan-500/25 db-commerce-jewel db-commerce-visual-v2" data-commerce-os="true" data-commerce-os-core="true" data-commerce-os-vibrant="true">
