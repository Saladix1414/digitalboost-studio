...
import { 
  ...
  Palette, ArrowRight, Hexagon, Undo2, Undo2
} from 'lucide-react';
...
export const ToolWorkspace = ({ initialMode, onBack }: ToolWorkspaceProps) => {
  ...
  const runAction = (action: string) => {
    ...
    switch (action) {
      case 'start':
        setCurrentMode('web');
        setViewTab('preview');
        setActionMessage('🚀 Proyecto iniciado correctamente.');
        break;

      case 'demo':
        setViewTab('preview');
        setActionMessage('▶️ Demo activada.');
        break;

      case 'contact':
        setCurrentMode('web');
        setActionMessage('📩 Formulario de contacto preparado.');
        break;

      case 'initial-plan':
        setCurrentMode('web');
        setActionMessage('✅ Plan Inicial seleccionado.');
        break;

      case 'pro-plan':
        setCurrentMode('pro');
        setActionMessage('⚡ Plan Pro IA seleccionado.');
        break;

      case 'add-product':
        setCurrentMode('store');
        setActionMessage('➕ Catálogo listo para agregar un producto.');
        break;
      ...
      case 'trial':
        ...
        setActionMessage('🎯 Prueba gratuita iniciada.');
        break;

      case 'mint':
        setCurrentMode('nft');
        setActionMessage('🔮 Solicitud de mint preparada. Conecta tu wallet para continuar.');
        break;

      case 'export':
        setActionMessage('📦 Proyecto preparado para exportación HTML/React + Tailwind.');
        setMessages(prev => [
          ...prev,
          {
            role: 'ai',
            text: 'Proyecto preparado para exportación HTML/React + Tailwind.',
      ...
      default:
        setActionMessage('✅ Acción ejecutada.');
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-[#020204] flex flex-col font-sans z-[100] text-slate-300 overflow-hidden select-none animate-in fade-in duration-300">
      ...
      {actionMessage && (
        <div className="fixed top-20 right-4 z-[200] max-w-sm bg-[#0b0c1c] border border-[#3b82f6]/40 text-white px-4 py-3 rounded-xl shadow-2xl text-xs">
              ...
              <div className="flex-1 flex flex-col text-slate-200">
                ...
                <nav className="h-16 border-b border-[#1e293b] px-6 flex items-center justify-between bg-[#040408]/90 backdrop-blur-sm sticky top-0 z-10">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] text-white text-xs font-bold px-4 py-1.5 rounded-md hover:opacity-90"
                  >
                    Contactar
                  </button>
                </nav>
                  ...
                  <div className="p-6 sm:p-12 space-y-16">
                    ...
                    <div className="text-center max-w-3xl mx-auto py-8">
                      ...
                      <div className="flex flex-wrap justify-center gap-4">
                        ...
                        className="bg-[#3b82f6] hover:bg-[#2563eb] text-white text-xs sm:text-sm font-bold px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 transition-all"
                      >
                          Empezar Ahora <ArrowRight size={16}/>
                        </button>
                        <button
                        onClick={() => setViewTab('preview')}
                        className="border border-slate-700 hover:bg-white/5 text-slate-300 text-xs sm:text-sm font-bold px-6 py-3 rounded-lg transition-all"
                      >
                          Ver Demostración
                        </button>
                      </div>
                      ...
                      <div className="border-t border-[#1e293b] pt-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                          <div className="bg-[#080811] border border-slate-800 p-6 rounded-xl flex flex-col">
                            ...
                            <button
                              onClick={() => runAction('initial-plan')}
                              className="w-full py-2.5 rounded-lg border border-slate-700 text-xs font-bold hover:bg-white/5"
                            >
                              Elegir Inicial
                            </button>
                          </div>
                          <div className="bg-[#0a0c1a] border border-[#3b82f6]/60 p-6 rounded-xl flex flex-col relative shadow-[0_0_30px_rgba(59,130,246,0.15)]">
                            ...
                            <button
                              ...
                              className="w-full py-2.5 rounded-lg bg-[#3b82f6] text-white text-xs font-bold hover:bg-[#2563eb] shadow-md"
                            >
                              Comenzar Pro
                            </button>
                          </div>
                  ...
                  <div className="p-6 sm:p-10 space-y-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#080812] border border-[#1e293b] p-6 rounded-xl">
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => runAction('add-product')}
                          className="bg-gradient-to-r from-[#8b5cf6] to-[#3b82f6] text-white text-xs font-bold px-4 py-2 rounded-lg flex items-center gap-1.5 shadow-md"
                        >
                          ...
                          <div className="p-4 flex-1 flex flex-col justify-between">
                            ...
                            <div className="mt-4 flex items-center justify-between pt-3 border-t border-slate-800">
                              ...
                              <button
                                ...
                                className="bg-white/10 hover:bg-[#8b5cf6] text-white text-xs font-semibold px-3 py-1.5 rounded transition-colors"
                              >
                                Comprar
                              </button>
                            </div>
                      ...
                      <div className="bg-[#080812] border border-[#1e293b] p-6 rounded-2xl max-w-md mx-auto shadow-2xl">
                        ...
                        <div className="space-y-3">
                          ...
                          <button
                            ...
                            className="w-full bg-gradient-to-r from-[#f472b6] to-[#8b5cf6] text-white text-xs font-bold py-2.5 rounded-lg shadow-lg hover:opacity-90 transition-all"
                          >
                ...
                {currentMode === 'nft' && (
                  <div className="p-6 sm:p-10 space-y-8">
                    <div className="bg-gradient-to-r from-[#170a2b] to-[#080812] border border-[#a855f7]/40 p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <button
                        onClick={() => runAction('mint')}
                        className="bg-[#a855f7] hover:bg-[#9333ea] text-white text-xs font-bold px-5 py-2.5 rounded-lg shadow-[0_0_20px_rgba(168,85,247,0.4)]"
                      >
                        Mintear NFT (0.5 SOL)
                      </button>
                    </div>
