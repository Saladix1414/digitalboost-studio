...
const filteredProducts = useMemo(() => {
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-[#475569]">
                    ...
                    Website Builder, Analytics y PULSE.
                  </p>
                </div>
              </div>
            </div>
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            navigateTo(item.id as StoreSection);
                            setMobileMenu(false);
                          }}
 ...
 Volver
      ...
      {showAI && (<DigitalBoostOperator onOpenHealth={() => setShowHealth(true)} onOpenAutomations={() => setShowAutomations(true)} onOpenConsole={() => setShowConsole(true)} section={section} onClose={() => { setShowAI(false); }} onNavigate={(id) => { setShowAI(false); setSection(id); }} />)}
      {false && (
