...
export function decide(input: PulseInput): PulseDecision {
  ...
  add(["hola", "quien", "sos", "pulse"], "PULSE IA", st(input) + ". ¿Ventas, pedidos, stock o el canvas?", "dashboard", "Seguir acá");
  ...
  if (!packs.length) {
    ...
    else pick = { title: "PULSE IA", body: "¿Cifras del OS o el canvas? Decime ventas, 1048, o hero.", action: input.section || "dashboard", label: "Seguir acá", score: 0 };
