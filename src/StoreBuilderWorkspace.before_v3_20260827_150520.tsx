import "./store-builder-light-background-final.css";
...
const filteredProducts = useMemo(() => {
  ...
  const renderDashboard = () => {
    ...
    const MetricCard = ({
      ...
      <button
        type="button"
        onClick={() => goTo(target)}
        className="group relative overflow-hidden rounded-2xl border border-cyan-300/20 bg-[#10182B] p-5 text-left transition hover:-translate-y-0.5 hover:border-violet-400/30 hover:bg-[#172F5A]"
      >
    ...
    return (
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
          ...
          {/* ACTIVIDAD */}
          <div className="rounded-2xl border border-cyan-300/20 bg-[#10182B] p-5">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#10182B] p-4 text-left transition hover:border-cyan-400/20"
              >
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#10182B] p-4 text-left transition hover:border-violet-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-300">
                  Entregados
                </p>
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#10182B] p-4 text-left transition hover:border-amber-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-300">
                  Enviados
                </p>
            ...
            <div className="mt-4 rounded-xl border border-white/[.07] bg-[#10182B] p-4">
              ...
              <div className="mt-4 grid grid-cols-4 gap-2">
                ...
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => goTo("orders")}
                    className="rounded-lg border border-white/[.06] bg-[#10182B] p-3 text-left transition hover:border-cyan-300/25"
                  >
          ...
          <div className="mt-4 space-y-2">
            {orders.slice(0, 4).map((order) => (
              <button
                ...
                type="button"
                onClick={() => goTo("orders")}
                className="group flex w-full items-center gap-3 rounded-xl border border-white/[.06] bg-[#10182B] p-3 text-left transition hover:border-cyan-300/25"
              >
      ...
      <Panel title="Estado del inventario">
        <div className="space-y-4">
          {products.map((product) => (
            <div
              key={product.id}
              className="flex items-center justify-between rounded-lg border border-white/[.07] bg-[#10182B] p-4"
            >
              <div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="Seguimiento">
            <div className="p-5">
                      ...
                      <div
                        className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border text-xs ${
                          isCompleted
                            ...
                            : "border-cyan-300/20 bg-[#10182B]/[.02] text-slate-300"
                        }`}
                      >
                        {isCompleted ? "✓" : index + 1}
                      </div>
              ...
              <div className="mt-5 rounded-xl border border-white/[.07] bg-[#10182B] p-4">
          ...
          <div className="border-b border-slate-200 p-4">
            <div className="flex flex-col gap-3 md:flex-row">
              <input
                ...
                className="w-full rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2.5 text-sm text-white outline-none placeholder:text-slate-300 focus:border-violet-400/40"
              />
              ...
              <select
                ...
                className="rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2.5 text-sm text-slate-300 outline-none focus:border-violet-400/40"
              >
                ...
                <tbody>
                  {filteredCustomers.map((customer) => (
                    <tr
                      ...
                      className="cursor-pointer border-b border-white/[.05] transition hover:bg-[#10182B]/[.025] last:border-0"
                    >
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Panel title="Actividad del cliente">
            <div className="grid grid-cols-2 gap-3 p-5">
              <div className="rounded-xl border border-cyan-300/20 bg-[#10182B] p-4">
                <p className="text-[10px] text-slate-300">
                  Pedidos pagados
                </p>
                <p className="mt-1 text-lg font-semibold text-emerald-300">
        ...
        {aiCustomerId === customer.id && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#10182B] p-5 shadow-2xl">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold text-white">
  ...
  const renderCampaigns = () => (
    <div className="space-y-6">
      {campaignToView && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-cyan-400/20 bg-[#10182B] p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-white">
            ...
            <div className="mt-4 rounded-xl border border-cyan-300/20 bg-[#10182B] p-4">
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-medium text-slate-300">
                  Estado
                </p>
      ...
      {campaignToDelete && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-cyan-300/20 bg-[#10182B] p-5 shadow-2xl">
          ...
          <div className="space-y-4 p-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2.5 text-xs text-white outline-none focus:border-violet-400/40"
              />
            </div>
            ...
            <div className="rounded-lg border border-cyan-300/20 bg-[#10182B] p-3">
              <p className="text-[11px] font-medium text-slate-300">
          ...
          {campaigns.map((campaign) => (
            <Panel key={campaign.id} title={campaign.name}>
              <div className="p-5">
                ...
                <div className="mt-4 rounded-lg border border-cyan-300/20 bg-[#10182B] p-3">
                  <p className="text-[11px] font-medium text-slate-300">
                    Secuencia automática
                  </p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={collection.name}
                  className="rounded-2xl border border-cyan-300/20 bg-[#10182B] p-5 transition hover:border-violet-400/30 hover:bg-[#172F5A]"
                >
                  <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="mt-5 rounded-xl border border-white/[.07] bg-[#10182B] p-3">
                    <p className="text-[10px] uppercase tracking-wider text-slate-300">
                      Próximamente
                    </p>
                    <p className="mt-1 text-xs text-slate-300">
            ...
            <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div
                    key={name}
                    className="rounded-xl border border-cyan-300/20 bg-[#10182B] p-4"
                  >
      ...
      case "payments":
        return (
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-cyan-300/20 bg-[#10182B] p-6">
              <p className="text-sm font-semibold text-white">
                Centro de pagos
              </p>
              <p className="mt-2 text-xs leading-5 text-slate-300">
              ...
              <div className="rounded-2xl border border-cyan-300/20 bg-[#10182B] p-5">
                ...
                <div className="mt-5 space-y-3">
                  {[
                    ...
                    <div
                      key={title}
                      className="flex flex-col gap-3 rounded-xl border border-white/[.07] bg-[#10182B] p-4 sm:flex-row sm:items-center sm:justify-between"
                    >
              ...
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
                ...
                <div className="mt-5 space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-lg border border-white/[.07] bg-[#10182B] px-3 py-2.5 text-[11px] text-slate-300"
                    >
                      ✓ {item}
                    </div>
                  ))}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#070B16] text-white">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[250px] flex-col border-r border-white/[.07] bg-[#0B1020] transition-transform lg:relative lg:translate-x-0 ${
      ...
      >
                        ...
                        <button
                          ...
                          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-xs transition ${
                            active
                              ...
                              : "border border-transparent text-slate-300 hover:border-white/[.06] hover:bg-[#151F36] hover:text-slate-200"
                          }`}
                        >
                          <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition ${
                              active
                                ? "bg-violet-500/20 text-violet-300"
                                : "bg-[#10182B]/[.025] text-slate-300 group-hover:bg-[#151F36] group-hover:text-slate-300"
                            }`}
                          >
                            <Icon size={15} />
                          </span>
        ...
        <div className="mt-auto border-t border-slate-200 p-3">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-300 hover:bg-[#151F36] hover:text-white"
          >
            <Settings size={17} />
            Configuración
          </button>
          ...
          <button
            onClick={onBack}
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-300 hover:bg-[#151F36] hover:text-white"
          >
            <ArrowLeft size={17} />
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-slate-200 bg-[#070B16]/95 px-4 backdrop-blur-xl lg:px-7">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setMobileMenu(true)}
              className="rounded-lg p-2 text-slate-300 hover:bg-[#151F36] lg:hidden"
            >
              <Menu size={20} />
            </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-lg p-2 text-slate-300 hover:bg-[#151F36]">
              <Bell size={18} />
            </button>
      ...
      {showAI && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#10182B] shadow-2xl">
            ...
            <div className="space-y-3 p-5">
              {[
                ...
                <button
                  ...
                  disabled={aiLoading}
                  className="flex w-full items-center justify-between rounded-lg border border-white/[.07] bg-[#10182B] p-3 text-left text-sm transition hover:border-violet-400/30 disabled:cursor-wait disabled:opacity-60"
                >
                  <span>{prompt}</span>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          value={campaignName}
                          onChange={(e) => setCampaignName(e.target.value)}
                          className="w-full rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2 text-xs text-white outline-none focus:border-violet-400/40"
                        />
                      </div>
            ...
            <div className="border-t border-slate-200 p-5">
              <div className="rounded-lg border border-cyan-300/20 bg-[#10182B] p-3 text-xs leading-5 text-slate-300">
      ...
      {showAddProduct && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
          <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-cyan-300/20 bg-[#10182B] shadow-2xl">

            <div className="sticky top-0 flex items-center justify-between border-b border-cyan-300/20 bg-[#10182B] p-5">
              <div>
                <h3 className="font-semibold">
            ...
            <div className="space-y-5 p-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2.5 text-sm outline-none focus:border-cyan-400/50"
                />
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-lg border border-cyan-300/20 bg-[#10182B] px-3 py-2.5 text-sm outline-none"
                  >
...
function Metric({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-[#10182B] p-5">
...
function Panel({
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-[#10182B] p-5">
      {title && (
...
function Insight({
  ...
  return (
    <div className="rounded-lg border border-white/[.06] bg-[#10182B] p-3">
        ...
        <tbody>
          {orders.map((order) => (
            <tr
              ...
              className="cursor-pointer border-b border-white/[.06] transition hover:bg-[#10182B]/[.02]"
            >
