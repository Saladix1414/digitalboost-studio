      ...
      if (prompt === "Analiza este cliente" && aiCustomerId !== null) {
        ...
        if (!customer) {
          ...
          result =
            ...
            `🟢 Estado: ${status}\n\n` +
            (customer.orders > 1
              ? "💡 Oportunidad detectada: este cliente ya mostró comportamiento recurrente.\n\n" +
                "🎯 Acción recomendada: crear una oferta personalizada para incentivar una nueva compra."
              : customer.spent >= 100
              ? "💡 Oportunidad detectada: cliente de alto valor con potencial de recompra.\n\n" +
                "🎯 Acción recomendada: ofrecer un producto complementario o una promoción exclusiva."
              : "💡 Oportunidad detectada: todavía existe margen para aumentar el valor de este cliente.\n\n" +
                "🎯 Acción recomendada: impulsar una segunda compra mediante una oferta personalizada.");
        }
        ...
        if (!order) {
          ...
          result =
            ...
            `📅 Fecha: ${order.date}\\n` +
            `📌 Estado: ${order.status}\\n\\n` +
            "💡 Oportunidad: Martín realizó su primera compra y el pedido ya está pagado. Es un buen momento para asegurar una experiencia de entrega positiva y preparar una acción de recompra.\\n\\n" +
            "🎯 Próxima acción: hacer seguimiento del pedido y, una vez entregado, ofrecer un producto complementario relacionado con su compra.";
        }
        ...
        result =
          ...
          (bestOrder
            ...
            : "") +
          "💡 Oportunidad detectada: analizar los productos y clientes asociados a los pedidos de mayor valor.\n\n" +
          "🎯 Acción recomendada: priorizar campañas sobre clientes con mayor potencial de compra.";
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="Resumen">
            <div className="p-5">
              <div className="rounded-xl border border-white/[.07] bg-[#030711] p-4">
                ...
                <p className="mt-2 text-xs leading-5 text-slate-500">
                  ...
                  podremos agregar seguimiento, cambios de estado y acciones
                  del AI Store Operator.
                </p>
              </div>
            </div>
          </Panel>
