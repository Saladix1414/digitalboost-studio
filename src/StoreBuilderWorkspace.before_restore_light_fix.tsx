...
import WebsiteBuilderV2 from "./WebsiteBuilderV2";
import StoreBuilderStudioShell from "./StoreBuilderStudioShell";
import "./store-builder-light-surface.css";
type StoreSection =
  | "dashboard"
  | "products"
  | "inventory"
...
const filteredProducts = useMemo(() => {
  ...
  const renderDashboard = () => {
    ...
    const MetricCard = ({
      ...
      <button
        type="button"
        onClick={() => goTo(target)}
        className="group relative overflow-hidden rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5 text-left transition hover:-translate-y-0.5 hover:border-violet-400/30 hover:bg-[#EEF3F9]"
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <ChevronRight
            size={16}
            className="text-slate-300 transition group-hover:translate-x-1 group-hover:text-violet-300"
          />
        </div>

        <p className="mt-5 text-[11px] font-medium uppercase tracking-wider text-slate-300">
          {title}
        </p>
    ...
    return (
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
          ...
          {/* ACTIVIDAD */}
          <div className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4 text-left transition hover:border-cyan-400/20"
              >
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4 text-left transition hover:border-violet-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-300">
                  Entregados
                </p>
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4 text-left transition hover:border-amber-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-300">
                  Enviados
                </p>
            ...
            <div className="mt-4 rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4">
              ...
              <div className="mt-4 grid grid-cols-4 gap-2">
                ...
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => goTo("orders")}
                    className="rounded-lg border border-white/[.06] bg-[#FFFFFF] p-3 text-left transition hover:border-cyan-300/25"
                  >
          ...
          <div className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5">
            ...
            <div className="mt-4 space-y-2">
              ...
              >
                ...
                <ChevronRight
                  size={14}
                  className="text-slate-300 group-hover:text-red-300"
                />
              </button>
              ...
              >
                ...
                <ChevronRight
                  size={14}
                  className="text-slate-300 group-hover:text-orange-300"
                />
              </button>
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-4 text-[10px] uppercase tracking-wider text-slate-300">
          ...
          <button
            type="button"
            onClick={() => goTo("inventory")}
            className="group rounded-2xl border border-cyan-400/15 bg-cyan-500/15 p-5 text-left transition hover:border-cyan-400/30"
          >
            <div className="flex items-center justify-between">
              ...
              <ChevronRight
                size={15}
                className="text-slate-300 transition group-hover:translate-x-1 group-hover:text-cyan-300"
              />
            </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <ChevronRight
                size={15}
                className="text-slate-300 transition group-hover:translate-x-1 group-hover:text-emerald-300"
              />
            </div>
        ...
        <div className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={() => goTo("orders")}
              className="rounded-lg border border-cyan-300/20 px-3 py-1.5 text-[10px] text-slate-300 transition hover:bg-cyan-300/10 hover:text-white"
            >
              Ver todos
            </button>
          </div>
          ...
          <div className="mt-4 space-y-2">
            {orders.slice(0, 4).map((order) => (
              <button
                ...
                type="button"
                onClick={() => goTo("orders")}
                className="group flex w-full items-center gap-3 rounded-xl border border-white/[.06] bg-[#FFFFFF] p-3 text-left transition hover:border-cyan-300/25"
              >
                ...
                <div className="text-right">
                  ...
                  <ChevronRight
                    size={13}
                    className="ml-auto mt-1 text-slate-300 transition group-hover:translate-x-1 group-hover:text-violet-300"
                  />
                </div>
              </button>
            ))}
            ...
            {orders.length === 0 && (
              <div className="rounded-xl border border-dashed border-cyan-300/20 p-6 text-center">
      ...
      <Panel title="Estado del inventario">
        <div className="space-y-4">
          {products.map((product) => (
            <div
              key={product.id}
              className="flex items-center justify-between rounded-lg border border-white/[.07] bg-[#FFFFFF] p-4"
            >
              <div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="Seguimiento">
            <div className="p-5">
                      ...
                      <div
                        className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border text-xs ${
                          isCompleted
                            ...
                            : "border-cyan-300/20 bg-[#FFFFFF]/[.02] text-slate-300"
                        }`}
                      >
                        {isCompleted ? "✓" : index + 1}
                      </div>
              ...
              <div className="mt-5 rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4">
    ...
    return (
      <div className="space-y-6">
        ...
        <Panel title="Clientes registrados">
          <div className="border-b border-slate-200 p-4">
            <div className="flex flex-col gap-3 md:flex-row">
              <input
                ...
                className="w-full rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2.5 text-sm text-white outline-none placeholder:text-slate-300 focus:border-violet-400/40"
              />
              ...
              <select
                ...
                className="rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2.5 text-sm text-slate-300 outline-none focus:border-violet-400/40"
              >
                ...
                <button
                  ...
                  className={`rounded-full px-3 py-1.5 text-xs transition ${
                    customerFilter === value
                      ...
                      : "border border-cyan-300/20 text-slate-300 hover:text-slate-300"
                  }`}
                >
                  {label}
                </button>
          ...
          {filteredCustomers.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-slate-200 text-[11px] uppercase tracking-wide text-slate-300">
                ...
                <tbody>
                  {filteredCustomers.map((customer) => (
                    <tr
                      ...
                      className="cursor-pointer border-b border-white/[.05] transition hover:bg-[#FFFFFF]/[.025] last:border-0"
                    >
          ...
          <div className="border-t border-slate-200 px-5 py-3 text-xs text-slate-300">
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Panel title="Actividad del cliente">
            <div className="grid grid-cols-2 gap-3 p-5">
              <div className="rounded-xl border border-cyan-300/20 bg-[#FFFFFF] p-4">
                <p className="text-[10px] text-slate-300">
                  Pedidos pagados
                </p>
                <p className="mt-1 text-lg font-semibold text-emerald-300">
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg border border-cyan-400/20 px-4 py-2.5 text-xs font-semibold text-cyan-300 transition hover:bg-cyan-500/15"
                >
                  <Megaphone size={15} />
                  Crear campaña
                </button>
        ...
        {aiCustomerId === customer.id && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#FFFFFF] p-5 shadow-2xl">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold text-white">
                ...
                <button
                  ...
                  className="rounded-lg border border-cyan-300/20 px-2.5 py-1.5 text-xs text-slate-300 transition hover:bg-cyan-300/10 hover:text-white"
                >
                  Cerrar
                </button>
              </div>
  ...
  const renderCampaigns = () => (
    <div className="space-y-6">
      {campaignToView && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-cyan-400/20 bg-[#FFFFFF] p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-white">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-cyan-300/20 bg-[#FFFFFF] p-4">
                <p className="text-[10px] text-slate-300">Alcance</p>
              ...
              <div className="rounded-xl border border-cyan-300/20 bg-[#FFFFFF] p-4">
                <p className="text-[10px] text-slate-300">Conversiones</p>
                <p className="mt-1 text-lg font-semibold text-white">
            ...
            <div className="mt-4 rounded-xl border border-cyan-300/20 bg-[#FFFFFF] p-4">
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-medium text-slate-300">
                  Estado
                </p>
              ...
              <div className="mt-3">
                <p className="text-[10px] text-slate-300">Audiencia</p>
                <p className="mt-1 text-xs leading-5 text-slate-300">
              ...
              <div className="mt-3">
                <p className="text-[10px] text-slate-300">Descuento</p>
                <p className="mt-1 text-xs text-slate-300">
      ...
      {campaignToDelete && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5 shadow-2xl">
            ...
            <div className="mt-5 flex justify-end gap-2">
              <button
                ...
                className="rounded-lg border border-cyan-300/20 px-4 py-2 text-xs text-slate-300 transition hover:bg-cyan-300/10 hover:text-white"
              >
                Cancelar
              </button>
          ...
          <div className="space-y-4 p-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2.5 text-xs text-white outline-none focus:border-violet-400/40"
              />
            </div>
            ...
            <div className="rounded-lg border border-cyan-300/20 bg-[#FFFFFF] p-3">
              <p className="text-[11px] font-medium text-slate-300">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-cyan-300/20 px-4 py-2.5 text-xs text-slate-300 transition hover:bg-cyan-300/10"
              >
                Cancelar
              </button>
            </div>
            ...
            <Panel key={campaign.id} title={campaign.name}>
              <div className="p-5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    <button
                      ...
                      className="rounded-lg border border-cyan-300/20 px-3 py-1.5 text-[11px] text-slate-300 transition hover:bg-cyan-300/10"
                    >
                    ...
                    <button
                      ...
                      className="rounded-lg border border-cyan-400/20 px-3 py-1.5 text-[11px] text-cyan-300 transition hover:bg-cyan-500/15"
                    >
                      📊 Ver rendimiento
                    </button>
                ...
                <div className="mt-4 grid gap-3 text-xs text-slate-300 md:grid-cols-2">
                  <div>
                    <p className="text-[11px] text-slate-300">Audiencia</p>
                    <p className="mt-1 text-slate-300">{campaign.audience}</p>
                  </div>

                  <div>
                    <p className="text-[11px] text-slate-300">Descuento</p>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 md:grid-cols-4">
                  ...
                  <div className="rounded-lg border border-cyan-300/20 bg-[#FFFFFF] p-3">
                    <p className="text-[10px] text-slate-300">Carritos recuperados</p>
                    <p className="mt-1 text-sm font-semibold text-white">
                  ...
                  <div className="rounded-lg border border-cyan-300/20 bg-[#FFFFFF] p-3">
                    <p className="text-[10px] text-slate-300">Ventas generadas</p>
                ...
                <div className="mt-4 rounded-lg border border-cyan-300/20 bg-[#FFFFFF] p-3">
                  <p className="text-[11px] font-medium text-slate-300">
                    Secuencia automática
                  </p>
        ...
        <Panel title="Rendimiento de campañas">
          {campaigns.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-slate-200 text-[10px] uppercase tracking-wide text-slate-300">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={collection.name}
                  className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5 transition hover:border-violet-400/30 hover:bg-[#EEF3F9]"
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      type="button"
                      className="rounded-lg border border-cyan-300/20 px-2.5 py-1.5 text-[10px] text-slate-300 transition hover:bg-cyan-300/10 hover:text-white"
                    >
                      Administrar
                    </button>
                  </div>
                  ...
                  <div className="mt-5 rounded-xl border border-white/[.07] bg-[#FFFFFF] p-3">
                    <p className="text-[10px] uppercase tracking-wider text-slate-300">
                      Próximamente
                    </p>
                    <p className="mt-1 text-xs text-slate-300">
            ...
            <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div
                    key={name}
                    className="rounded-xl border border-cyan-300/20 bg-[#FFFFFF] p-4"
                  >
                    <div className="h-24 rounded-lg border border-cyan-300/20 bg-gradient-to-br from-violet-500/10 via-cyan-500/5 to-transparent" />
      ...
      case "payments":
        return (
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-6">
              <p className="text-sm font-semibold text-white">
                Centro de pagos
              </p>
              <p className="mt-2 text-xs leading-5 text-slate-300">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
                ...
                <p className="mt-2 text-3xl font-bold text-white">
                  82<span className="text-sm text-slate-300">/100</span>
                </p>
              ...
              <div className="rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] p-5">
                ...
                <div className="mt-5 space-y-3">
                  {[
                    ...
                    <div
                      key={title}
                      className="flex flex-col gap-3 rounded-xl border border-white/[.07] bg-[#FFFFFF] p-4 sm:flex-row sm:items-center sm:justify-between"
                    >
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-lg border border-cyan-300/20 px-3 py-2 text-[10px] text-slate-300 transition hover:bg-cyan-300/10 hover:text-white"
                      >
                        {action}
                      </button>
                    </div>
              ...
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
                ...
                <div className="mt-5 space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-lg border border-white/[.07] bg-[#FFFFFF] px-3 py-2.5 text-[11px] text-slate-300"
                    >
                      ✓ {item}
                    </div>
                  ))}
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F8FAFC] text-white"
        data-store-builder-light-surface="true">
      {mobileMenu && (
        <div
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[250px] flex-col border-r border-white/[.07] bg-[#FFFFFF] transition-transform lg:relative lg:translate-x-0 ${
      ...
      >
        <div className="flex h-[72px] items-center justify-between border-b border-slate-200 px-5">
          ...
          >
            ...
            <div>
              ...
              <div className="text-[9px] font-medium tracking-widest text-slate-300">
                STORE
              </div>
            </div>
          </button>
              ...
              return (
                <div key={group.id}>
                  <button
                    ...
                    className="mb-2 flex w-full items-center justify-between px-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-300 transition hover:text-slate-300"
                  >
                        ...
                        <button
                          ...
                          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-xs transition ${
                            active
                              ...
                              : "border border-transparent text-slate-300 hover:border-white/[.06] hover:bg-[#F5F7FB] hover:text-slate-200"
                          }`}
                        >
                          <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition ${
                              active
                                ? "bg-violet-500/20 text-violet-300"
                                : "bg-[#FFFFFF]/[.025] text-slate-300 group-hover:bg-[#F5F7FB] group-hover:text-slate-300"
                            }`}
                          >
                            <Icon size={15} />
                          </span>
        ...
        <div className="mt-auto border-t border-slate-200 p-3">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-300 hover:bg-[#F5F7FB] hover:text-white"
          >
            <Settings size={17} />
            Configuración
          </button>
          ...
          <button
            onClick={onBack}
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-300 hover:bg-[#F5F7FB] hover:text-white"
          >
            <ArrowLeft size={17} />
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-slate-200 bg-[#F8FAFC]/95 px-4 backdrop-blur-xl lg:px-7">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setMobileMenu(true)}
              className="rounded-lg p-2 text-slate-300 hover:bg-[#F5F7FB] lg:hidden"
            >
              <Menu size={20} />
            </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-lg p-2 text-slate-300 hover:bg-[#F5F7FB]">
              <Bell size={18} />
            </button>
      ...
      {showAI && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#FFFFFF] shadow-2xl">
            ...
            <div className="space-y-3 p-5">
              {[
                ...
                <button
                  ...
                  disabled={aiLoading}
                  className="flex w-full items-center justify-between rounded-lg border border-white/[.07] bg-[#FFFFFF] p-3 text-left text-sm transition hover:border-violet-400/30 disabled:cursor-wait disabled:opacity-60"
                >
                  <span>{prompt}</span>
                ...
                <div className="rounded-xl border border-violet-400/20 bg-violet-500/20 p-4">
                  ...
                  {!aiLoading && aiResult && (
                    <button
                      ...
                      className="mt-4 rounded-lg border border-cyan-300/20 px-3 py-2 text-xs text-slate-300 hover:bg-cyan-300/10"
                    >
                      Nueva consulta
                    </button>
                  )}
                  ...
                  {campaignCreated ? (
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="rounded-lg border border-cyan-300/20 px-3 py-2 text-xs text-slate-300 hover:bg-cyan-300/10"
                      >
                        Cerrar
                      </button>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          value={campaignName}
                          onChange={(e) => setCampaignName(e.target.value)}
                          className="w-full rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2 text-xs text-white outline-none focus:border-violet-400/40"
                        />
                      </div>
            ...
            <div className="border-t border-slate-200 p-5">
              <div className="rounded-lg border border-cyan-300/20 bg-[#FFFFFF] p-3 text-xs leading-5 text-slate-300">
      ...
      {showAddProduct && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
          <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-cyan-300/20 bg-[#FFFFFF] shadow-2xl">

            <div className="sticky top-0 flex items-center justify-between border-b border-cyan-300/20 bg-[#FFFFFF] p-5">
              <div>
                <h3 className="font-semibold">
              ...
              <button
                ...
                className="rounded-lg p-2 text-slate-300 hover:bg-cyan-300/10 hover:text-white"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="space-y-5 p-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2.5 text-sm outline-none focus:border-cyan-400/50"
                />
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-lg border border-cyan-300/20 bg-[#FFFFFF] px-3 py-2.5 text-sm outline-none"
                  >
                    ...
                    <button
                      ...
                      className={`rounded-lg border px-4 py-3 text-sm ${
                        productForm.status === status
                          ...
                          : "border-cyan-300/20 text-slate-300"
                      }`}
                    >
                      {status}
                    </button>
              ...
              <div className="rounded-lg border border-violet-400/10 bg-violet-500/20 p-3 text-xs leading-5 text-slate-300">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 rounded-lg border border-cyan-300/20 px-4 py-3 text-sm text-slate-300"
                >
                  Cancelar
                </button>
...
function Panel({
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-[#FFFFFF] p-5">
      {title && (
...
function Insight({
  ...
  return (
    <div className="rounded-lg border border-white/[.06] bg-[#FFFFFF] p-3">
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full min-w-[650px] text-left text-sm">
        <thead className="border-b border-cyan-300/20 text-xs text-slate-300">
          <tr>
        ...
        <tbody>
          {orders.map((order) => (
            <tr
              ...
              className="cursor-pointer border-b border-white/[.06] transition hover:bg-[#FFFFFF]/[.02]"
            >
              ...
              <td className="text-xs text-slate-300">{order.date}</td>
            </tr>
          ))}
        </tbody>
      </table>
