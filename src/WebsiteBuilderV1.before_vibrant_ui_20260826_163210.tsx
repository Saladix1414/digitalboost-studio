...
export default function WebsiteBuilderV1({
  ...
  return (
    <div className="min-h-[720px] overflow-hidden rounded-2xl border border-white/[.08] bg-[#020711] text-white shadow-2xl">
      {/* APPLICATION TOP BAR */}
      <div className="flex h-16 items-center justify-between border-b border-white/[.07] bg-[#050a13]/95 px-3 backdrop-blur-xl sm:px-5">
        <div className="flex min-w-0 items-center gap-3">
          <button
            type="button"
            onClick={onBack}
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-white/[.03] text-slate-400 transition hover:border-cyan-400/30 hover:text-white"
            title="Volver"
          >
            <ArrowLeft size={17} />
          </button>
        ...
        <div className="hidden items-center gap-1 rounded-xl border border-white/[.07] bg-black/20 p-1 md:flex">
          {[
            ["desktop", Monitor],
            ["tablet", Tablet],
            ["mobile", Smartphone],
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="hidden h-9 w-9 items-center justify-center rounded-lg text-slate-500 transition hover:bg-white/5 hover:text-white disabled:opacity-30 sm:flex"
            title="Deshacer"
          >
            <Undo2 size={16} />
          </button>
          ...
          <button
            type="button"
            onClick={save}
            className="flex h-9 items-center gap-2 rounded-lg border border-violet-400/25 bg-violet-500/10 px-3 text-xs font-semibold text-violet-200 transition hover:bg-violet-500/20"
          >
            <Save size={15} />
            <span className="hidden sm:inline">
      ...
      <div className="flex min-h-[650px]">
        {/* LEFT PANEL */}
        {!preview && showLeft && (
          <aside className="hidden w-[245px] shrink-0 border-r border-white/[.07] bg-[#040912] lg:block">
            <div className="flex h-12 items-center justify-between border-b border-white/[.06] px-4">
            ...
            <div className="space-y-2 p-3">
              <div className="mb-4 rounded-xl border border-cyan-400/10 bg-cyan-400/[.035] p-3">
              ...
              {blockCatalog.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="group flex w-full items-center gap-3 rounded-xl border border-white/[.06] bg-white/[.015] p-3 text-left transition hover:border-cyan-400/20 hover:bg-white/[.035]"
                  >
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-white/[.07] bg-white/[.03] text-slate-400 transition group-hover:text-cyan-300">
                      <Icon size={16} />
                    </div>
        ...
        <main className="relative min-w-0 flex-1 bg-[#080d16]">
          ...
          <div className="relative flex h-full flex-col">
            <div className="flex h-12 shrink-0 items-center justify-between border-b border-white/[.06] bg-[#070c15]/80 px-3 sm:px-5">
            ...
            <div className="flex-1 overflow-auto p-4 sm:p-8">
              <div
                className="mx-auto overflow-hidden rounded-xl border border-white/10 bg-white shadow-2xl transition-all duration-300"
                style={{ width }}
              >
                {/* WEBSITE PREVIEW */}
                <div className="min-h-[600px] bg-[#0a1020] text-white">
                  {blocks
                    ...
                    .map((block, index) => {
                      ...
                      return (
                        ...
                        >
                          {!preview && (
                            <div className="absolute left-3 top-3 z-20 flex items-center gap-1 rounded-md border border-white/10 bg-black/70 px-2 py-1 text-[9px] text-slate-300 opacity-0 backdrop-blur group-hover:opacity-100">
                          ...
                          {!preview && index === 0 && (
                            <div className="absolute left-3 top-3 z-30 flex items-center gap-1 rounded-md border border-cyan-400/30 bg-[#06111d]/90 px-2 py-1 text-[9px] font-medium text-cyan-300 shadow-xl">
                  ...
                  {blocks.length === 0 && (
                    <div className="flex min-h-[600px] items-center justify-center bg-[#0a1020]">
                      <div className="text-center">
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl border border-cyan-400/20 bg-cyan-400/5 text-cyan-300">
                          <Plus size={22} />
                        </div>
        ...
        {/* RIGHT INSPECTOR */}
        {!preview && showRight && (
          <aside className="hidden w-[260px] shrink-0 border-l border-white/[.07] bg-[#040912] xl:block">
            <div className="flex h-12 items-center justify-between border-b border-white/[.06] px-4">
            ...
            <div className="p-4">
              {selected ? (
                <>
                  <div className="rounded-xl border border-violet-400/15 bg-violet-400/[.04] p-4">
                    <div className="text-[9px] font-semibold uppercase tracking-[.18em] text-violet-300">
                  ...
                  <div className="mt-5">
                    <div className="mb-2 text-[10px] font-semibold uppercase tracking-[.15em] text-slate-500">
                      Acciones
                    </div>
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-lg border border-white/[.07] bg-white/[.02] px-3 py-2.5 text-left text-xs text-slate-400 transition hover:border-cyan-400/20 hover:text-white"
                      >
                        <Copy size={14} />
                        Duplicar sección
                      </button>
                  ...
                  <div className="mt-6 border-t border-white/[.06] pt-5">
                    <div className="mb-3 flex items-center justify-between">
                      <div className="text-[10px] font-semibold uppercase tracking-[.15em] text-slate-500">
                        Propiedades
                      </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          className="mt-1.5 w-full rounded-lg border border-white/[.08] bg-black/20 px-3 py-2 text-xs text-white outline-none transition focus:border-cyan-400/30"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <button
                          ...
                          className="mt-1.5 flex w-full items-center justify-between rounded-lg border border-white/[.08] bg-black/20 px-3 py-2 text-xs"
                        >
      ...
      {/* BOTTOM STATUS */}
      <div className="flex h-9 items-center justify-between border-t border-white/[.06] bg-[#030710] px-4 text-[9px] text-slate-600">
