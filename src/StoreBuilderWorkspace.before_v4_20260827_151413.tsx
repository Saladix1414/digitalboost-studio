...
import "./store-builder-v3-neon.css";
import "./store-builder-v4-clean-neon.css";
type StoreSection =
  | "dashboard"
  | "products"
  | "inventory"
...
const filteredProducts = useMemo(() => {
  ...
  const renderDashboard = () => {
    ...
    const MetricCard = ({
      ...
      <button
        type="button"
        onClick={() => goTo(target)}
        className="group relative overflow-hidden rounded-2xl border border-[#00B7FF]/30 bg-white p-5 text-left transition hover:-translate-y-0.5 hover:border-violet-400/30 hover:bg-[#E8F5FF]"
      >
        ...
        <p className="mt-1 text-2xl font-bold tracking-tight text-[#142033]">
          {value}
        </p>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-2xl font-bold tracking-tight text-[#142033]">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
          ...
          {/* ACTIVIDAD */}
          <div className="rounded-2xl border border-[#00B7FF]/30 bg-white p-5">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-[#D6E2EE] bg-white p-4 text-left transition hover:border-[#00B7FF]/30"
              >
                <p className="text-[10px] uppercase tracking-wider text-[#475569]">
                  Ticket promedio
                </p>

                <p className="mt-2 text-xl font-bold text-[#142033]">
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-[#D6E2EE] bg-white p-4 text-left transition hover:border-violet-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-[#475569]">
                  Entregados
                </p>
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-[#D6E2EE] bg-white p-4 text-left transition hover:border-amber-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-[#475569]">
                  Enviados
                </p>
            ...
            <div className="mt-4 rounded-xl border border-[#D6E2EE] bg-white p-4">
              ...
              <div className="mt-4 grid grid-cols-4 gap-2">
                ...
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => goTo("orders")}
                    className="rounded-lg border border-[#D6E2EE] bg-white p-3 text-left transition hover:border-cyan-300/25"
                  >
                    <p className="text-[9px] uppercase tracking-wider text-[#475569]">
                      {label}
                    </p>

                    <p className="mt-1 text-lg font-bold text-[#142033]">
                      {value}
                    </p>
                  </button>
                ))}
        ...
        <div className="rounded-2xl border border-[#00B7FF]/30 bg-white p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={() => goTo("orders")}
              className="rounded-lg border border-[#00B7FF]/30 px-3 py-1.5 text-[10px] text-[#475569] transition hover:bg-cyan-300/10 hover:text-[#142033]"
            >
              Ver todos
            </button>
          </div>
          ...
          <div className="mt-4 space-y-2">
            {orders.slice(0, 4).map((order) => (
              <button
                ...
                type="button"
                onClick={() => goTo("orders")}
                className="group flex w-full items-center gap-3 rounded-xl border border-[#D6E2EE] bg-white p-3 text-left transition hover:border-cyan-300/25"
              >
                ...
                <div className="text-right">
                  <p className="text-xs font-semibold text-[#142033]">
      ...
      <Panel title="Estado del inventario">
        <div className="space-y-4">
          {products.map((product) => (
            <div
              key={product.id}
              className="flex items-center justify-between rounded-lg border border-[#D6E2EE] bg-white p-4"
            >
              <div>
    ...
    return (
      <div className="space-y-6">
        <button
          ...
          className="flex items-center gap-2 text-sm text-[#475569] transition hover:text-[#142033]"
        >
          <ArrowLeft size={16} />
          Volver a Pedidos
        </button>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="Seguimiento">
            <div className="p-5">
                      ...
                      <div
                        className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border text-xs ${
                          isCompleted
                            ...
                            : "border-[#00B7FF]/30 bg-white/[.02] text-[#475569]"
                        }`}
                      >
                        {isCompleted ? "✓" : index + 1}
                      </div>
              ...
              <div className="mt-5 rounded-xl border border-[#D6E2EE] bg-white p-4">
    ...
    return (
      <div className="space-y-6">
        ...
        <Panel title="Clientes registrados">
          <div className="border-b border-slate-200 p-4">
            <div className="flex flex-col gap-3 md:flex-row">
              <input
                ...
                className="w-full rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2.5 text-sm text-[#142033] outline-none placeholder:text-[#475569] focus:border-violet-400/40"
              />
              ...
              <select
                ...
                className="rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2.5 text-sm text-[#475569] outline-none focus:border-violet-400/40"
              >
          ...
          {filteredCustomers.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-slate-200 text-[11px] uppercase tracking-wide text-[#475569]">
                ...
                <tbody>
                  {filteredCustomers.map((customer) => (
                    <tr
                      ...
                      className="cursor-pointer border-b border-[#D6E2EE] transition hover:bg-white/[.025] last:border-0"
                    >
          ...
          <div className="border-t border-slate-200 px-5 py-3 text-xs text-[#475569]">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Panel title="Actividad del cliente">
            <div className="grid grid-cols-2 gap-3 p-5">
              <div className="rounded-xl border border-[#00B7FF]/30 bg-white p-4">
                <p className="text-[10px] text-[#475569]">
                  Pedidos pagados
                </p>
                <p className="mt-1 text-lg font-semibold text-emerald-300">
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-violet-500 px-4 py-2.5 text-xs font-semibold text-[#142033] transition hover:bg-violet-400"
                >
                  <Sparkles size={15} />
                  Analizar con AI Operator
                </button>
            ...
            <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-white p-5 shadow-2xl">
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="rounded-lg border border-[#00B7FF]/30 px-2.5 py-1.5 text-xs text-[#475569] transition hover:bg-cyan-300/10 hover:text-[#142033]"
                >
                  Cerrar
                </button>
              </div>
  ...
  const renderCampaigns = () => (
    <div className="space-y-6">
      {campaignToView && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/20 px-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-[#00B7FF]/30 bg-white p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-[#142033]">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-[#00B7FF]/30 bg-white p-4">
                ...
                <p className="mt-1 text-lg font-semibold text-[#142033]">
            ...
            <div className="mt-4 rounded-xl border border-[#00B7FF]/30 bg-white p-4">
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-medium text-[#475569]">
                  Estado
                </p>
      ...
      {campaignToDelete && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/20 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-[#00B7FF]/30 bg-white p-5 shadow-2xl">
            ...
            <div className="mt-5 flex justify-end gap-2">
              <button
                ...
                className="rounded-lg border border-[#00B7FF]/30 px-4 py-2 text-xs text-[#475569] transition hover:bg-cyan-300/10 hover:text-[#142033]"
              >
                Cancelar
              </button>
              ...
              <button
                ...
                className="rounded-lg bg-red-500/90 px-4 py-2 text-xs font-semibold text-[#142033] transition hover:bg-red-400"
              >
                Eliminar campaña
              </button>
            </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg bg-violet-500 px-4 py-2.5 text-xs font-semibold text-[#142033] transition hover:bg-violet-400"
        >
          <Plus size={15} />
          ...
          <div className="space-y-4 p-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2.5 text-xs text-[#142033] outline-none focus:border-violet-400/40"
              />
            </div>
            ...
            <div className="rounded-lg border border-[#00B7FF]/30 bg-white p-3">
              <p className="text-[11px] font-medium text-[#475569]">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 rounded-lg bg-violet-500 px-4 py-2.5 text-xs font-semibold text-[#142033] transition hover:bg-violet-400"
              >
                Crear campaña
              </button>
          ...
          {campaigns.map((campaign) => (
            <Panel key={campaign.id} title={campaign.name}>
              <div className="p-5">
                ...
                <div className="mt-4 rounded-lg border border-[#00B7FF]/30 bg-white p-3">
                  <p className="text-[11px] font-medium text-[#475569]">
                    Secuencia automática
                  </p>
          ...
          <Panel title="Estado de pedidos">
            <div className="grid grid-cols-2 gap-3 p-5">
              <div className="rounded-xl border border-[#00B7FF]/30 bg-white p-4">
                ...
                <p className="mt-1 text-xl font-semibold text-[#142033]">
                  {paidOrders}
                </p>
              </div>
        ...
        <Panel title="Rendimiento de campañas">
          {campaigns.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-slate-200 text-[10px] uppercase tracking-wide text-[#475569]">
    ...
    switch (section) {
      ...
      case "themes":
        return (
          <div className="space-y-6">
            <div>
              <p className="text-lg font-semibold text-[#142033]">
                Temas
              </p>
              <p className="mt-1 text-sm text-[#475569]">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={collection.name}
                  className="rounded-2xl border border-[#00B7FF]/30 bg-white p-5 transition hover:border-violet-400/30 hover:bg-[#E8F5FF]"
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      type="button"
                      className="rounded-lg border border-[#00B7FF]/30 px-2.5 py-1.5 text-[10px] text-[#475569] transition hover:bg-cyan-300/10 hover:text-[#142033]"
                    >
                      Administrar
                    </button>
                  </div>

                  <p className="mt-4 text-sm font-semibold text-[#142033]">
                    {collection.name}
                  </p>
                  ...
                  <div className="mt-5 rounded-xl border border-[#D6E2EE] bg-white p-3">
                    <p className="text-[10px] uppercase tracking-wider text-[#475569]">
                      Próximamente
                    </p>
                    <p className="mt-1 text-xs text-[#475569]">
            ...
            <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div
                    key={name}
                    className="rounded-xl border border-[#00B7FF]/30 bg-white p-4"
                  >
      ...
      case "payments":
        return (
          <div className="space-y-6">
            <div>
              <p className="text-lg font-semibold text-[#142033]">Pagos</p>
              <p className="mt-1 text-sm text-[#475569]">
                Configuración y seguimiento de los pagos de tu tienda.
              </p>
            </div>

            <div className="rounded-2xl border border-[#00B7FF]/30 bg-white p-6">
              <p className="text-sm font-semibold text-[#142033]">
                Centro de pagos
              </p>
              <p className="mt-2 text-xs leading-5 text-[#475569]">
      ...
      case "marketing":
        return (
          <div className="space-y-6">
            <div>
              <p className="text-lg font-semibold text-[#142033]">Marketing</p>
              <p className="mt-1 text-sm text-[#475569]">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-4">
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
                ...
                <p className="mt-2 text-3xl font-bold text-[#142033]">
              ...
              <div className="rounded-2xl border border-[#00B7FF]/30 bg-white p-5">
                ...
                <div className="mt-5 space-y-3">
                  {[
                    ...
                    <div
                      key={title}
                      className="flex flex-col gap-3 rounded-xl border border-[#D6E2EE] bg-white p-4 sm:flex-row sm:items-center sm:justify-between"
                    >
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-lg border border-[#00B7FF]/30 px-3 py-2 text-[10px] text-[#475569] transition hover:bg-cyan-300/10 hover:text-[#142033]"
                      >
                        {action}
                      </button>
                    </div>
              ...
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/20 p-5">
                ...
                <div className="mt-5 space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-lg border border-[#D6E2EE] bg-white px-3 py-2.5 text-[11px] text-[#475569]"
                    >
                      ✓ {item}
                    </div>
                  ))}
                ...
                <button
                  type="button"
                  className="mt-5 w-full rounded-lg bg-gradient-to-r from-violet-500 to-cyan-500 px-4 py-2.5 text-[11px] font-semibold text-[#142033] transition hover:opacity-90"
                >
                  Analizar con AI
                </button>
              </div>
  ...
  return (
    <div data-store-builder="true" className="flex h-screen overflow-hidden bg-[#F6F9FC] text-[#142033]">
      {mobileMenu && (
        <div
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[250px] flex-col border-r border-[#D6E2EE] bg-white transition-transform lg:relative lg:translate-x-0 ${
      ...
      >
                      ...
                      return (
                        <button
                          ...
                          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-xs transition ${
                            active
                              ? "border border-violet-400/20 bg-violet-500/20 text-[#142033] shadow-[0_0_24px_rgba(139,92,246,0.08)]"
                              : "border border-transparent text-[#475569] hover:border-[#D6E2EE] hover:bg-[#F0F5FA] hover:text-[#334155]"
                          }`}
                        >
                          <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition ${
                              active
                                ? "bg-violet-500/20 text-violet-300"
                                : "bg-white/[.025] text-[#475569] group-hover:bg-[#F0F5FA] group-hover:text-[#475569]"
                            }`}
                          >
                            <Icon size={15} />
                          </span>
        ...
        <div className="mt-auto border-t border-slate-200 p-3">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-[#475569] hover:bg-[#F0F5FA] hover:text-[#142033]"
          >
            <Settings size={17} />
            Configuración
          </button>
          ...
          <button
            onClick={onBack}
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-[#475569] hover:bg-[#F0F5FA] hover:text-[#142033]"
          >
            <ArrowLeft size={17} />
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-slate-200 bg-[#F6F9FC]/95 px-4 backdrop-blur-xl lg:px-7">
          <div className="flex items-center gap-3">
            <button
              onClick={() => setMobileMenu(true)}
              className="rounded-lg p-2 text-[#475569] hover:bg-[#F0F5FA] lg:hidden"
            >
              <Menu size={20} />
            </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="rounded-lg p-2 text-[#475569] hover:bg-[#F0F5FA]">
              <Bell size={18} />
            </button>
      ...
      {showAI && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/20 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-white shadow-2xl">
            ...
            <div className="space-y-3 p-5">
              {[
                ...
                <button
                  ...
                  disabled={aiLoading}
                  className="flex w-full items-center justify-between rounded-lg border border-[#D6E2EE] bg-white p-3 text-left text-sm transition hover:border-violet-400/30 disabled:cursor-wait disabled:opacity-60"
                >
                  <span>{prompt}</span>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          value={campaignName}
                          onChange={(e) => setCampaignName(e.target.value)}
                          className="w-full rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2 text-xs text-[#142033] outline-none focus:border-violet-400/40"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full rounded-lg bg-violet-500 px-4 py-2.5 text-xs font-semibold text-[#142033] transition hover:bg-violet-400"
                      >
                        Crear campaña
                      </button>
                    </div>
            ...
            <div className="border-t border-slate-200 p-5">
              <div className="rounded-lg border border-[#00B7FF]/30 bg-white p-3 text-xs leading-5 text-[#475569]">
      ...
      {showAddProduct && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/20 p-4 backdrop-blur-sm">
          <div className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-[#00B7FF]/30 bg-white shadow-2xl">

            <div className="sticky top-0 flex items-center justify-between border-b border-[#00B7FF]/30 bg-white p-5">
              <div>
                <h3 className="font-semibold">
              ...
              <button
                ...
                className="rounded-lg p-2 text-[#475569] hover:bg-cyan-300/10 hover:text-[#142033]"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="space-y-5 p-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2.5 text-sm outline-none focus:border-cyan-400/50"
                />
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-lg border border-[#00B7FF]/30 bg-white px-3 py-2.5 text-sm outline-none"
                  >
...
function Insight({
  ...
  return (
    <div className="rounded-lg border border-[#D6E2EE] bg-white p-3">
        ...
        <tbody>
          {orders.map((order) => (
            <tr
              ...
              className="cursor-pointer border-b border-[#D6E2EE] transition hover:bg-white/[.02]"
            >
