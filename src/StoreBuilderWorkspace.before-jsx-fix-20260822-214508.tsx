          ...
          <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#070d18] shadow-2xl">
            ...
            <div className="border-t border-white/[.07] p-5">
                <div className="rounded-xl border border-violet-400/20 bg-violet-500/5 p-4">
                  ...
                  {!aiLoading &&
                    aiResult &&
                    aiAction === "¿Qué productos necesitan reposición?" && (
                      <button
                        onClick={goToLowStock}
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-violet-500"
                      >
                        <Package size={15} />
                        Ver inventario bajo
                      </button>
