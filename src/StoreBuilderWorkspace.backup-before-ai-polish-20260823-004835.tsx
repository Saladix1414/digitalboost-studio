      ...
      if (prompt === "Analiza este cliente" && aiCustomerId !== null) {
        ...
        if (!order) {
          ...
          result =
            ...
            `📅 Fecha: ${order.date}\\n` +
            `📌 Estado: ${order.status}\\n\\n` +
            "💡 Oportunidad detectada: revisar el estado del pedido y el historial del cliente para identificar una próxima acción comercial.\\n\\n" +
            "🎯 Acción recomendada: mantener el seguimiento del pedido y preparar una oportunidad de recompra o producto complementario cuando corresponda.";
        }
