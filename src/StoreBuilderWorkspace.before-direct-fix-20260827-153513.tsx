...
import "./store-builder-v4-neon-dark.css";
type StoreSection =
  | "dashboard"
  | "products"
  | "inventory"
...
const filteredProducts = useMemo(() => {
  ...
  return (
    <div data-store-builder="true" className="flex h-screen overflow-hidden bg-[#F6F9FC] text-white">
      {mobileMenu && (
        <div
      ...
      >
                        ...
                        >
                          <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition ${
                              active
                                ? "bg-violet-500/20 text-violet-300"
                                : "bg-[#0B1B30]/[.025] text-[#475569] group-hover:bg-[#F0F5FA] group-hover:text-[#475569]"
                            }`}
                          >
                            <Icon size={15} />
                          </span>
        ...
        <div className="mt-auto border-t border-[#1D4260] p-3">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-[#475569] hover:bg-[#F0F5FA] hover:text-white"
          >
            <Settings size={17} />
            Configuración
          </button>
          ...
          <button
            onClick={onBack}
            className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-[#475569] hover:bg-[#F0F5FA] hover:text-white"
          >
            <ArrowLeft size={17} />
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-[#1D4260] bg-[#F6F9FC]/95 px-4 backdrop-blur-xl lg:px-7">
          <div className="flex items-center gap-3">
            <button
