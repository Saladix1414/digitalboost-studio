...
const filteredProducts = useMemo(() => {
  ...
  const renderDashboard = () => {
    ...
    const MetricCard = ({
      ...
      <button
        type="button"
        onClick={() => goTo(target)}
        className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#070b14] p-5 text-left transition hover:-translate-y-0.5 hover:border-violet-400/30 hover:bg-[#0a0f1c]"
      >
        ...
        <p className="mt-5 text-[11px] font-medium uppercase tracking-wider text-slate-500">
          {title}
        </p>
    ...
    return (
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 xl:grid-cols-[1.35fr_.65fr]">
          ...
          {/* ACTIVIDAD */}
          <div className="rounded-2xl border border-white/10 bg-[#070b14] p-5">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="rounded-lg border border-violet-400/20 px-3 py-1.5 text-[10px] font-medium text-violet-300 transition hover:bg-violet-500/10"
              >
                Ver Analytics
              </button>
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#030711] p-4 text-left transition hover:border-cyan-400/20"
              >
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#030711] p-4 text-left transition hover:border-violet-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-600">
                  Entregados
                </p>
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="rounded-xl border border-white/[.07] bg-[#030711] p-4 text-left transition hover:border-amber-400/20"
              >
                <p className="text-[10px] uppercase tracking-wider text-slate-600">
                  Enviados
                </p>
            ...
            <div className="mt-4 rounded-xl border border-white/[.07] bg-[#030711] p-4">
              ...
              <div className="mt-4 grid grid-cols-4 gap-2">
                ...
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => goTo("orders")}
                    className="rounded-lg border border-white/[.06] bg-[#070b14] p-3 text-left transition hover:border-white/15"
                  >
          ...
          <div className="rounded-2xl border border-white/10 bg-[#070b14] p-5">
            ...
            <div className="mt-4 space-y-2">
              ...
              >
                ...
                <ChevronRight
                  size={14}
                  className="text-slate-600 group-hover:text-red-300"
                />
              </button>
              ...
              >
                ...
                <ChevronRight
                  size={14}
                  className="text-slate-600 group-hover:text-orange-300"
                />
              </button>
              ...
              <button
                type="button"
                onClick={() => goTo("orders")}
                className="group flex w-full items-center gap-3 rounded-xl border border-cyan-400/10 bg-cyan-500/5 p-3 text-left transition hover:border-cyan-400/25"
              >
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <button
            ...
            className="group rounded-2xl border border-violet-400/15 bg-violet-500/5 p-5 text-left transition hover:border-violet-400/30"
          >
            <div className="flex items-center justify-between">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-500/10 text-violet-300">
                <Package size={17} />
          ...
          <button
            type="button"
            onClick={() => goTo("inventory")}
            className="group rounded-2xl border border-cyan-400/15 bg-cyan-500/5 p-5 text-left transition hover:border-cyan-400/30"
          >
            <div className="flex items-center justify-between">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#070b14] p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={() => goTo("orders")}
              className="rounded-lg border border-white/10 px-3 py-1.5 text-[10px] text-slate-400 transition hover:bg-white/5 hover:text-white"
            >
              Ver todos
            </button>
          </div>
          ...
          <div className="mt-4 space-y-2">
            {orders.slice(0, 4).map((order) => (
              <button
                ...
                type="button"
                onClick={() => goTo("orders")}
                className="group flex w-full items-center gap-3 rounded-xl border border-white/[.06] bg-[#030711] p-3 text-left transition hover:border-white/15"
              >
                ...
                <div className="text-right">
                  ...
                  <ChevronRight
                    size={13}
                    className="ml-auto mt-1 text-slate-600 transition group-hover:translate-x-1 group-hover:text-violet-300"
                  />
                </div>
              </button>
            ))}
      ...
      <div className="space-y-6">
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg border border-cyan-400/20 px-4 py-2.5 text-xs font-semibold text-cyan-300 transition hover:bg-cyan-500/10"
                >
                  <Megaphone size={15} />
                  Crear campaña
                </button>
        ...
        {aiCustomerId === customer.id && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-2xl border border-violet-400/20 bg-[#070b14] p-5 shadow-2xl">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold text-white">
  ...
  const renderCampaigns = () => (
    <div className="space-y-6">
      {campaignToView && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-cyan-400/20 bg-[#070b14] p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-white">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-white/10 bg-[#030711] p-4">
                <p className="text-[10px] text-slate-500">Alcance</p>
              ...
              <div className="rounded-xl border border-white/10 bg-[#030711] p-4">
                <p className="text-[10px] text-slate-500">Conversiones</p>
                <p className="mt-1 text-lg font-semibold text-white">
            ...
            <div className="mt-4 rounded-xl border border-white/10 bg-[#030711] p-4">
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-medium text-slate-300">
                  Estado
                </p>
              ...
              <div className="mt-3">
                <p className="text-[10px] text-slate-500">Audiencia</p>
              ...
              <div className="mt-3">
                <p className="text-[10px] text-slate-500">Descuento</p>
          ...
          <div className="space-y-4 p-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-[#030711] px-3 py-2.5 text-xs text-white outline-none focus:border-violet-400/40"
              />
            </div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-white/10 px-4 py-2.5 text-xs text-slate-400 transition hover:bg-white/5"
              >
                Cancelar
              </button>
            </div>
            ...
            <Panel key={campaign.id} title={campaign.name}>
              <div className="p-5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-cyan-400/20 px-3 py-1.5 text-[11px] text-cyan-300 transition hover:bg-cyan-500/10"
                    >
                      📊 Ver rendimiento
                    </button>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 md:grid-cols-4">
                  ...
                  <div className="rounded-lg border border-white/10 bg-[#030711] p-3">
                    <p className="text-[10px] text-slate-500">Carritos recuperados</p>
                    <p className="mt-1 text-sm font-semibold text-white">
                  ...
                  <div className="rounded-lg border border-white/10 bg-[#030711] p-3">
                    <p className="text-[10px] text-slate-500">Ventas generadas</p>
        ...
        <Panel title="Rendimiento de campañas">
          {campaigns.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-white/[.07] text-[10px] uppercase tracking-wide text-slate-500">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                <div
                  key={collection.name}
                  className="rounded-2xl border border-white/10 bg-[#070b14] p-5 transition hover:border-violet-400/30 hover:bg-[#0a0f1c]"
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-500/10 text-xl">
                      {collection.icon}
                    </div>

                    <button
                      type="button"
                      className="rounded-lg border border-white/10 px-2.5 py-1.5 text-[10px] text-slate-400 transition hover:bg-white/5 hover:text-white"
                    >
                      Administrar
                    </button>
                  </div>
                  ...
                  <div className="mt-5 rounded-xl border border-white/[.07] bg-[#030711] p-3">
                    <p className="text-[10px] uppercase tracking-wider text-slate-600">
                      Próximamente
                    </p>
            ...
            <div className="rounded-2xl border border-violet-400/20 bg-violet-500/5 p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div
                    key={name}
                    className="rounded-xl border border-white/10 bg-[#030711] p-4"
                  >
                    <div className="h-24 rounded-lg border border-white/10 bg-gradient-to-br from-violet-500/10 via-cyan-500/5 to-transparent" />
                    ...
                    <button
                      type="button"
                      className="mt-3 w-full rounded-lg border border-violet-400/20 px-3 py-2 text-[10px] text-violet-300 transition hover:bg-violet-500/10"
                    >
                      Vista previa
                    </button>
                  </div>
      ...
      case "payments":
        return (
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#070b14] p-6">
              <p className="text-sm font-semibold text-white">
                Centro de pagos
              </p>
              <p className="mt-2 text-xs leading-5 text-slate-500">
            ...
            <div className="grid gap-5 lg:grid-cols-[1.25fr_.75fr]">
              <div className="rounded-2xl border border-white/10 bg-[#070b14] p-5">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    type="button"
                    className="rounded-lg border border-violet-400/20 px-3 py-2 text-[10px] text-violet-300 transition hover:bg-violet-500/10"
                  >
                    Auditar tienda
                  </button>
                </div>
                ...
                <div className="mt-5 space-y-3">
                  {[
                    ...
                    <div
                      key={title}
                      className="flex flex-col gap-3 rounded-xl border border-white/[.07] bg-[#030711] p-4 sm:flex-row sm:items-center sm:justify-between"
                    >
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-lg border border-white/10 px-3 py-2 text-[10px] text-slate-300 transition hover:bg-white/5 hover:text-white"
                      >
                        {action}
                      </button>
                    </div>
              ...
              <div className="rounded-2xl border border-violet-400/20 bg-violet-500/5 p-5">
                ...
                <div className="mt-5 space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-lg border border-white/[.07] bg-[#030711] px-3 py-2.5 text-[11px] text-slate-400"
                    >
                      ✓ {item}
                    </div>
                  ))}
                ...
                <button
                  type="button"
                  className="mt-5 w-full rounded-lg bg-gradient-to-r from-violet-600 to-cyan-500 px-4 py-2.5 text-[11px] font-semibold text-white transition hover:opacity-90"
                >
                  Analizar con AI
                </button>
              </div>
              ...
              return (
                <div key={group.id}>
                  <button
                    ...
                    className="mb-2 flex w-full items-center justify-between px-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-600 transition hover:text-slate-300"
                  >
                      ...
                      return (
                        <button
                          ...
                          className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-xs transition ${
                            active
                              ? "border border-violet-400/20 bg-violet-500/10 text-white shadow-[0_0_24px_rgba(139,92,246,0.08)]"
                              : "border border-transparent text-slate-500 hover:border-white/[.06] hover:bg-white/[.035] hover:text-slate-200"
                          }`}
                        >
                          <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition ${
                              active
                                ...
                                : "bg-white/[.025] text-slate-600 group-hover:bg-white/[.05] group-hover:text-slate-300"
                            }`}
                          >
                            <Icon size={15} />
                          </span>
