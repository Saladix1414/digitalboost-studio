      ...
      if (prompt === "Analiza este cliente" && aiCustomerId !== null) {
        ...
        if (!order) {
          ...
          result =
            ...
            `📅 Fecha: ${order.date}\n` +
            `📌 Estado: ${order.status}\n\n` +
            `💡 Oportunidad: el pedido ya está pagado y corresponde a ${order.items} producto${order.items === 1 ? "" : "s"}. Es una buena oportunidad para cuidar la experiencia de entrega y preparar la siguiente interacción comercial.\n\n` +
            "🎯 Próxima acción: hacer seguimiento del pedido y, una vez entregado, ofrecer un producto complementario relacionado con la compra.";
        }
